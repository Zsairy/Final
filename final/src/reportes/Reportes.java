...
public class Reportes {
    public void ReporteFacultad () throws SQLException, JRException{
        ...
        reporte = (JasperReport) JRLoader.loadObjectFromFile("C:\\Users\\franc\\Desktop\\final\\Final\\final\\src\\reportes\\Facultad.jasper");
     ...
     public void ReporteEscuela () throws SQLException, JRException{
        ...
        con = DriverManager.getConnection("jdbc:postgresql://localhost:5432/proyecto","tutorias","123");
        JasperReport reporte = null;
        reporte = (JasperReport) JRLoader.loadObjectFromFile("C:\\Users\\franc\\Desktop\\final\\Final\\final\\src\\reportes\\Escuela.jasper");
        JasperPrint print = JasperFillManager.fillReport(reporte , null, con);
        JasperViewer ver = new JasperViewer(print,false);
      ...
      public void ReporteNiveles () throws SQLException, JRException{
        ...
        con = DriverManager.getConnection("jdbc:postgresql://localhost:5432/proyecto","tutorias","123");
        JasperReport reporte = null;
        reporte = (JasperReport) JRLoader.loadObjectFromFile("C:\\Users\\franc\\Desktop\\final\\Final\\final\\src\\reportes\\Nivel.jasper");
        JasperPrint print = JasperFillManager.fillReport(reporte , null, con);
        JasperViewer ver = new JasperViewer(print,false);
        ver.setTitle("Nivel");
        ver.setVisible(true);
